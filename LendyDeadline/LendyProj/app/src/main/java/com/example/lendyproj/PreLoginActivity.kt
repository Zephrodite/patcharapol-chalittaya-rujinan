        ...
        Firebase.auth.signInWithCredential(credential)
            .addOnCompleteListener(activity) { task ->
                if (task.isSuccessful) {
                    ...
                    val currentUser = mAuth2.currentUser
                    ...
                    val usernameTxt = currentUser.displayName
                    val emailTxt = currentUser.email
                    val imageTxt = currentUser.photoUrl
                    val uId = UserId(usernameTxt.toString(), emailTxt.toString(), imageTxt.toString(), uniqId.toString())
