...
class MemberAdapterVer2(private val items: ArrayList<Member>,
                        private val listener: BookshelfFragment
): RecyclerView.Adapter<MemberAdapterVer2.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_member_2, parent, false))
    }
